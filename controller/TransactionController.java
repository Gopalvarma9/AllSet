...
public class TransactionController {
	...
	public String getDepositMoney(@Validated transactioninfo tarn, Model model,HttpServletRequest request) {
	...
	public String getmoneywithdrawl(@Validated transactioninfo tarn, Model model,HttpServletRequest request) {
	...
	public String getloanmoneywithdrawl(@Validated transactioninfo tarn, Model model,HttpServletRequest request) {
	...
	public String loanrepaymenturl(@Validated tempRepayment tarn, Model model,HttpServletRequest request) {
